...
/**
  ...
  */
void
RCSwitch::setProtocol(int nProtocol) {
...
/**
  ...
  */
void
RCSwitch::setProtocol(int nProtocol, int nPulseLength) {
    this->nProtocol = nProtocol;
    if (nProtocol == 1){
...
/**
  ...
  */
void
RCSwitch::setPulseLength(int nPulseLength) {
 ...
 */
void
RCSwitch::setRepeatTransmit(int nRepeatTransmit) {
 ...
 */
void
RCSwitch::setReceiveTolerance(int nPercent) {
 ...
 */
void
RCSwitch::enableTransmit(int nTransmitterPin) {
 ...
 * @param nDevice  Number of device (1..4)
  */
void
RCSwitch::switchOn(char sFamily, int nGroup, int nDevice) {
 ...
 */
void
RCSwitch::switchOff(char sFamily, int nGroup, int nDevice) {
 ...
 */
void
RCSwitch::switchOn(int nAddressCode, int nChannelCode) {
 ...
 */
void
RCSwitch::switchOff(int nAddressCode, int nChannelCode) {
 ...
 */
void
RCSwitch::switchOn(char *sGroup, int nChannel) {
 ...
 */
void
RCSwitch::switchOff(char *sGroup, int nChannel) {
 ...
 */
char *
RCSwitch::getCodeWordB(int nAddressCode, int nChannelCode, boolean bStatus) {
    int nReturnPos = 0;
 ...
 */
char *
RCSwitch::getCodeWordA(char *sGroup, int nChannelCode, boolean bStatus) {
    int nReturnPos = 0;
    static char sReturn[13];
 ...
 */
char *
RCSwitch::getCodeWordC(char sFamily, int nGroup, int nDevice, boolean bStatus) {
    static char sReturn[13];
    int nReturnPos = 0;
 ...
 */
void
RCSwitch::sendTriState(char *sCodeWord) {
...
void
RCSwitch::send(unsigned long Code, unsigned int length) {
    this->send( this->dec2binWzerofill(Code, length) );
}

void
RCSwitch::send(char *sCodeWord) {
    for (int nRepeat=0; nRepeat<nRepeatTransmit; nRepeat++) {
        int i = 0;
        while (sCodeWord[i] != '\0') {
            switch(sCodeWord[i]) {
...
void
RCSwitch::transmit(int nHighPulses, int nLowPulses) {
 ...
 */
void
RCSwitch::enableReceive(int interrupt) {
 ...
 */
bool
RCSwitch::receiveProtocol1(unsigned int changeCount){
...
bool
RCSwitch::receiveProtocol2(unsigned int changeCount){
    unsigned long code = 0;
...
/**
  ...
  */
char *
RCSwitch::dec2binWzerofill(unsigned long Dec, unsigned int bitLength){
    static char bin[64];
    unsigned int i=0;
